...
class iqr_retrieval_train(Dataset):

    def __init__(self, transform, image_root, ann_root, max_words=30, prompt=''):
        filename = 'train/short_itr_train.json'
...
class iqr_retrieval_eval(Dataset):
    ...
    def __init__(self, transform, image_root, ann_root, split, max_words=30):
        ...
        '''
        filenames = {'val': 'val/short_itr_val.json', 'test': 'val/short_itr_val.json'}
        self.split = split
